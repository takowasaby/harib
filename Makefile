...
haribote.img : haribote/ipl22.bin haribote/haribote.sys Makefile \
		...
		savannah.txt mmlplay/mmlplay.hrb gview/gview.hrb
	$(EDIMG)   imgin:../z_tools/fdimg0at.tek \
		wbinimg src:haribote/ipl22.bin len:512 from:0 to:0 \
		copy from:haribote/haribote.sys to:@: \
		copy from:haribote/ipl22.nas to:@: \
