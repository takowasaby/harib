OBJS_BOOTPACK = bootpack.obj naskfunc.obj hankaku.obj graphic.obj dsctbl.obj \
		...
		sheet.obj timer.obj mtask.obj console.obj file.obj \
		window.obj
...
lines.hrb : lines.bim Makefile
	${BIM2HRB} lines.bim lines.hrb 288k
...
haribote.img : ipl10.bin haribote.sys a.hrb hello3.hrb \
		hello4.hrb hello5.hrb winhelo.hrb winhelo2.hrb winhelo3.hrb star1.hrb \
		stars.hrb stars2.hrb lines.hrb walk.hrb noodle.hrb beepdown.hrb color.hrb \
		color2.hrb Makefile
